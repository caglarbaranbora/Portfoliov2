              ...
              <form onSubmit={handleSubmit} className="space-y-12 ">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    <span className="text-lg font-medium opacity-60">01</span>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    <span className="text-lg font-medium opacity-60">02</span>
                    <label className="text-2xl font-medium">
                      What&apos;s your email?
                    </label>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    <span className="text-lg font-medium opacity-60">03</span>
                    <label className="text-2xl font-medium">
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4">
                    <span className="text-lg font-medium opacity-60">04</span>
