            ...
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mb-16">
                ...
                <div className="sm:col-span-2 md:col-span-1">
                  ...
                  <Magnetic>
                    <Link
                      href="https://chat-app-caglar.vercel.app/"
                      target="_blank"
                      className="block px-4 sm:px-6 py-2 sm:py-3"
                    >
                      <span className="text-lg sm:text-xl font-semibold">
                        chat-app-caglar.vercel.app
                      </span>
                    </Link>
                  </Magnetic>
                </div>
                  ...
                  >
                    <div>
                      ...
                      <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-6">
                        @Chat is a simple and fast messaging app built with
                        React Native (Expo) and powered by Firebase. As the name
                        suggests, it focuses purely on real-time text
                        communication, offering a clean and distraction-free
                        chat experience.
                      </p>
                      <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
                        With no support for media sharing like photos, videos,
                        or audio recordings, @chat keeps conversations
                        lightweight, private, and focused on words — just how
                        messaging began.
                      </p>
                    </div>
                  </motion.div>
